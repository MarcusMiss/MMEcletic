...
class SubstitutionErrorTests {
    ...
    @Test("SubstitutionError errorDescription (de)",
          .enabled(if: Locale.current.identifier.elementsEqual("de_DE"))
    )
    func errorDescriptionDE() async throws {
        print("SubstitutionError.unknownSymbol: \(SubstitutionError.unknownSymbol(symbol: "SYM", expression: expr).localizedDescription)")
        ...
        print("SubstitutionError.invalidOpenToken: \(SubstitutionError.invalidOpenToken(symbol: "SYM").localizedDescription)")
        ...
        print("SubstitutionError.invalidCloseToken: \(SubstitutionError.invalidCloseToken(symbol: "SYM").localizedDescription)")
    ...
    @Test("SubstitutionError errorDescription (en)",
        .enabled(if: Locale.current.identifier.elementsEqual("en_GB")
                    || Locale.current.identifier.elementsEqual("en_US"))
    )
